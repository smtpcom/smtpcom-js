...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SmtpPublicApiOverview.StatusResponse();
  });
  ...
  describe('StatusResponse', function() {
    it('should create an instance of StatusResponse', function() {
      ...
      //var instane = new SmtpPublicApiOverview.StatusResponse();
      //expect(instance).to.be.a(SmtpPublicApiOverview.StatusResponse);
    });
