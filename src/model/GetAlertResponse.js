...
import GetAlertResponseData from './GetAlertResponseData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = GetAlertResponseData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
 ...
 */
GetAlertResponse.prototype['status'] = undefined;

/**
 * @member {module:model/GetAlertResponseData} data
 */
GetAlertResponse.prototype['data'] = undefined;
